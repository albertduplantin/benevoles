...
-- Correction du type de données pour mission_id
...
-- Vérifier le type de la colonne id dans la table missions
SELECT 'Type de la colonne id dans la table missions:' as info;
...
-- Recréer la table avec le bon schéma (mission_id en BIGINT)
