        ...
        <form ref={formRef} onSubmit={handleSubmit} className="p-4 mt-6 border rounded-lg bg-gray-50">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div className="md:col-span-2">
                    ...
                    <input type="text" name="title" id="title" required className="w-full mt-1 border-gray-300 rounded-md shadow-sm bg-white text-gray-900" style={{ colorScheme: 'light' }}/>
                </div>
                <div className="md:col-span-2">
                    <label htmlFor="description" className="block text-sm font-medium text-gray-700">Description</label>
                    <textarea name="description" id="description" rows={3} className="w-full mt-1 border-gray-300 rounded-md shadow-sm bg-white text-gray-900" style={{ colorScheme: 'light' }}></textarea>
                </div>
                <div>
                    <label htmlFor="location" className="block text-sm font-medium text-gray-700">Lieu</label>
                    <input type="text" name="location" id="location" required className="w-full mt-1 border-gray-300 rounded-md shadow-sm bg-white text-gray-900" style={{ colorScheme: 'light' }}/>
                </div>
                 <div>
                    <label htmlFor="max_volunteers" className="block text-sm font-medium text-gray-700">Bénévoles max</label>
                    <input type="number" name="max_volunteers" id="max_volunteers" required min="1" className="w-full mt-1 border-gray-300 rounded-md shadow-sm bg-white text-gray-900" style={{ colorScheme: 'light' }}/>
                </div>
                <div>
                    <label htmlFor="manager_id" className="block text-sm font-medium text-gray-700">Responsable (optionnel)</label>
                    <select name="manager_id" id="manager_id" className="w-full mt-1 border-gray-300 rounded-md shadow-sm bg-white text-gray-900" style={{ colorScheme: 'light' }}>
...
<<<<<<< HEAD
                    <input type="datetime-local" name="start_time" id="start_time" required className="w-full mt-1 border-gray-300 rounded-md shadow-sm bg-white text-gray-900" style={{ colorScheme: 'light' }}/>
                </div>
                <div>
                    <label htmlFor="end_time" className="block text-sm font-medium text-gray-700">Date et heure de fin</label>
                    <input type="datetime-local" name="end_time" id="end_time" required className="w-full mt-1 border-gray-300 rounded-md shadow-sm bg-white text-gray-900" style={{ colorScheme: 'light' }}/>
=======
                    <input
                        type="datetime-local"
                        name="start_time"
